        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Resolution List</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Resolution List</li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                    ...
                                    @foreach ($resolutions as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex" style="font-size: 20px">
                                                <a href="{{ route('resolutions.edit', $item->id) }}" class="me-2">
                            ...
                            {{ $resolutions->onEachSide(2)->links('admin.partials._pagination') }}
                        </div>
                    </div>
                </div>
            </div>
