                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3 pb-2">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea" placeholder="Enter your page description..."
                                            rows="6" name="info">{{ $page->info }}</textarea>
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="posterLinkInput"
                                            placeholder="Enter your poster link" name="poster" value="{{ $page->poster }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="trailerInput"
                                            placeholder="Facebook page link..." name="fb" value="{{ $page->fb }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
